  ...
  return (
    <div className="rounded-lg border border-[var(--border-default)] bg-[var(--bg-surface)]">
      <div className="px-4 py-3 border-b border-[var(--border-default)] bg-[var(--bg-subtle)]">
        ...
        <p className="text-xs text-[var(--text-secondary)] mt-0.5">NVIDIA H100 SXM vs AMD MI300X</p>
      </div>
      <div className="px-4 py-1">
        {/* Header */}
        <div className="grid grid-cols-3 py-2 border-b text-xs font-semibold text-[var(--text-secondary)] gap-2">
          <span></span>
