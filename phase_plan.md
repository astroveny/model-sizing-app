...
- [Phase Plan — model-sizing-app](#phase-plan--model-sizing-app)
  ...
  - [Phase 10 — LLM Settings \& Multi-Model Routing](#phase-10--llm-settings--multi-model-routing)
    - [☑ P10.1 — Database schema: configured\_models + settings\_kv](#-p101--database-schema-configured_models--settings_kv)
    - [☑ P10.2 — Encryption utility](#-p102--encryption-utility)
    - [☑ P10.3 — ConfiguredModel CRUD](#-p103--configuredmodel-crud)
    - [☑ P10.4 — Feature routing store](#-p104--feature-routing-store)
    - [☑ P10.5 — getLlmProviderForFeature wiring](#-p105--getllmproviderforfeature-wiring)
    - [☑ P10.6 — Call-site migration](#-p106--call-site-migration)
    - [☑ P10.7 — Backward-compat migration](#-p107--backward-compat-migration)
    - [☑ P10.8 — Settings page shell](#-p108--settings-page-shell)
    - [☑ P10.9 — Add Model dialog](#-p109--add-model-dialog)
    - [☑ P10.10 — Edit model row](#-p1010--edit-model-row)
    - [☑ P10.11 — Feature assignment checkboxes](#-p1011--feature-assignment-checkboxes)
    - [☑ P10.12 — Test Connection button](#-p1012--test-connection-button)
    - [☑ P10.13 — Clear Assignments button](#-p1013--clear-assignments-button)
    - [☑ P10.14 — Feature Routing Summary](#-p1014--feature-routing-summary)
    - [☑ P10.15 — UI disables for unassigned features](#-p1015--ui-disables-for-unassigned-features)
